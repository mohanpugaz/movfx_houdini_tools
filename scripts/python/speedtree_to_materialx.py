...
try:
    ...
    raise RuntimeError("This must run inside Houdini (hou module required).") from exc

STMAT = r"C:/Users/mohan/Desktop/plam_tree/game_palm/game_palm.stmat"
...
def build_materials():
    ...
    matlib = get_or_create_matlib(stage, "speedtree_materials")
